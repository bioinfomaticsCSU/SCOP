...
def cut_reads01(file01,file02,length):
...
def cut_reads02(file01,file02,length):
    n =0
    inf = open(file01)
    outf = open(file02,"w")
    for line in inf:
...
def main():
    ...
    parser.add_argument('l', metavar='length', type=int, help='the length of reads to be cut')
    ...
    out02 = args.o2
    l = args.l
    cut_reads01(file01,out01,l)
    cut_reads02(file02,out02,l)
